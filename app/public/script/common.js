...
$(document).on('click', '#landingBannerStarted,#toolsBannerStarted,.getStarted,.headerContactUs,#contactBannerButton,.headerItemBg.nav-header', function (e) {
...
$(document).on('click', '#contactFormSubmit', function (e) {
    var valid = document.getElementById('contactModalForm').checkValidity();
